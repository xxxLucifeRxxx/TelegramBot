...
namespace TelegramBot.Model
{
	public class Application
	{
		...
		public PaymentMethodEnum? PaymentMethod { get; set; }// На этапе составления заявки пользователь выбирает метод оплаты
		public ClaimStatusEnum? State { get; set; }// Определяет в каком состоянии находится заявка -Поиск водителя -Заказ принят -Заказ отменен
